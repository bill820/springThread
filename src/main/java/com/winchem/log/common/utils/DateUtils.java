package com.winchem.log.common.utils;
...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
     ...
     * @return 时间
     */
    public static String getDateStrByString(String time){
        return DateUtils.getDateStrByString(time, null);
    }

    public static String getDateStrByString(String time, String plan){
        if (StringUtils.isBlank(plan)) {
            plan = "yyyy-MM-dd";
        }
        Long times = DateUtils.getLongTimeByString(time, plan);
        return DateUtils.formatDate(times, plan);
    }
    ...
    public static Date getDateWithStr(String datestr) {
        return DateUtils.getDate(datestr, "yyyy-MM-dd HH:mm:ss");
    }

    /**
    *@Description: 根据日期字符串获取日期date
    *@Param:  * @param null :
    *@return:  * @return : null
    *@Author: zhanglb
...
//            }
    ...
    /**
     * 得到当前日期date(yyyy-MM-dd HH:mm:ss)
     */
...
//        return DateFormatUtils.format(new Date(), pattern);
    ...
    public static Date getDateYmd(Date date) {
        return getDate(DateUtils.getDateStr(date), "yyyy-MM-dd");
    }
...
//        String yyyyMM = new SimpleDateFormat("yyyyMM").format(date);
     ...
     * @return
     */
    public static Date addMinute(Date date, int hour){
...
//        System.out.println(formatDate(getOfDayLast(parseDate("2015/6/6")),"yyyy-MM-dd HH:mm:ss.sss"));
    ...
    /*    Date old = DateUtils.getDate("20201101235959", "yyyyMMddHHmmss");
        Date date1 = DateUtils.getOfDayLast(old);
        System.out.println(DateUtils.getDateStr(date1, "yyyyMMddHHmmss"));

        double i = DateUtils.getDistanceOfTwoDate(old, DateUtils.getDate("20201103235958", "yyyyMMddHHmmss"));
        System.out.println(i);

        Date deadDate = DateUtils.addDays(old, 3);
        System.out.println(DateUtils.getDateStr(deadDate, "yyyyMMddHHmmss"));*/

//        System.out.println(DateUtils.getDateStr(DateUtils.getOfDayFirst(new Date())));
//        System.out.println(DateUtils.getDateStr(DateUtils.getOfDayLast(new Date())));

//        System.out.println(DateUtils.getDateStr(DateUtils.minusDay(new Date(), 1)));
//        System.out.println(DateUtils.getDateStr(DateUtils.minusDay(DateUtils.getDateWithStr("2020-12-01 00:00:00"), 2)));
//        System.out.println(DateUtils.getDateStr(DateUtils.minusDay(DateUtils.getDateWithStr("2020-01-01 00:00:00"), 1)));


        System.out.println(DateUtils.getDateYmd(new Date()));
    }
